...
@JsonKey(name: 'name') String get name;//Name of the show
@JsonKey(name: 'permalink') String get permaLink;//Permalink of the show
@JsonKey(name: 'start_date') String get startDate;//start date of the show
@JsonKey(name: 'network') String get network;//network of the show
@JsonKey(name: 'image_thumbnail_path') String get imageThumbnailPath;//Image thumbnail path
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,permaLink,startDate,network,imageThumbnailPath,status);

@override
String toString() {
  return 'TvShows(name: $name, permaLink: $permaLink, startDate: $startDate, network: $network, imageThumbnailPath: $imageThumbnailPath, status: $status)';
}
...
@useResult
$Res call({
@JsonKey(name: 'name') String name,@JsonKey(name: 'permalink') String permaLink,@JsonKey(name: 'start_date') String startDate,@JsonKey(name: 'network') String network,@JsonKey(name: 'image_thumbnail_path') String imageThumbnailPath,@JsonKey(name: 'status') String status
});
...
/// Create a copy of TvShows
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? permaLink = null,Object? startDate = null,Object? network = null,Object? imageThumbnailPath = null,Object? status = null,}) {
  return _then(_self.copyWith(
...
class _TvShows implements TvShows {
   _TvShows({@JsonKey(name: 'name') this.name = '', @JsonKey(name: 'permalink') this.permaLink = '', @JsonKey(name: 'start_date') this.startDate = '', @JsonKey(name: 'network') this.network = '', @JsonKey(name: 'image_thumbnail_path') this.imageThumbnailPath = '', @JsonKey(name: 'status') this.status = ''});
...
/// Create a copy of TvShows
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? permaLink = null,Object? startDate = null,Object? network = null,Object? imageThumbnailPath = null,Object? status = null,}) {
